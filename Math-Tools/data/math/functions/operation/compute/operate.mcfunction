...
execute unless score #check var matches 0 store result storage calculator stack[-1] double -0.000000476837158203125 run attribute @s minecraft:generic.movement_speed get -2097152
...
execute if score #check var matches 0 store result storage calculator stack[-1] double 0.000000476837158203125 run attribute @s minecraft:generic.movement_speed get -2097152
