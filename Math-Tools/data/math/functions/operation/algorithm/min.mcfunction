...
# get minimum
execute if predicate math:is_negative run data remove storage calculator vec[0][-1]
execute unless predicate math:is_negative run data remove storage calculator vec[0][-2]